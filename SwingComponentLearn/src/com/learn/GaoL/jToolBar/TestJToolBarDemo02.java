package com.learn.GaoL.jToolBar;
...
public class TestJToolBarDemo02 {
	public static void main(String[] args) {
        ...
        // 为工具栏增加按钮
        JButton b1 = new JButton(new ImageIcon("resource/1.jpg"));
        JButton b2 = new JButton(new ImageIcon("resource/2.jpg"));
        JButton b3 = new JButton(new ImageIcon("resource/3.jpg"));
        JButton b4 = new JButton(new ImageIcon("resource/4.jpg"));
        JButton b5 = new JButton(new ImageIcon("resource/5.jpg"));
        JButton b6 = new JButton(new ImageIcon("resource/6.jpg"));
        tb.add(b1);
        tb.add(b2);
        tb.add(b3);
        tb.add(b4);
